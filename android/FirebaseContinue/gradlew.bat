...
@rem #
@rem # Copyright (c) 2017 Google Inc. All Rights Reserved.
@rem #
@rem # Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file
...
@rem # either express or implied. See the License for the specific language governing permissions
