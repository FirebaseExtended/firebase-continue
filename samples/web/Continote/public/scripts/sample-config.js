 ...
 * and the web app sample to share code, and putting this script there since it
 * currently overlaps (as of July 14, 2017). If this change is made, remember
 * to update the installation/setup guide!
 */
(function() {
  'use strict';
